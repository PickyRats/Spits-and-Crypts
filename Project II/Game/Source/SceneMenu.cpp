...
bool SceneMenu::Start()
{
	...
	settingsFxButton = (GuiControlSlider*)app->guiManager->CreateGuiControl(GuiControlType::SLIDER, 21, NULL, settingsSlider, settingsSlider, settingsSlider, { 570, 263, 30, 30 }, this, { 570, 248, 225, 50 });
